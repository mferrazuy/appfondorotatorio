...
<body class="login wp-core-ui">
    <div id="login">
        ...
        <h2 class="fondo-rotatorio">Formulario de ingreso Rendición Fondo Rotatorio</h2>
        <form name="loginform" id="loginform" action="auth.php"
            method="post">
            <p>
        ...
        <p id="nav">
            <a href="https://intranet.ejercito.mil.uy/intranet/wp-login.php?action=lostpassword">¿Olvidaste tu
                contraseña?</a>
        </p>
        ...
        <p id="backtoblog">
            <a href="https://intranet.ejercito.mil.uy/">← Ir a Ejercito Nacional</a>
        </p>
    </div>
    <script>
